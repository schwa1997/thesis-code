...
train_generator = train_datagen.flow_from_directory(
    r'C:\Users\huimin.chen\projects\chm-vowel\vowelRecognition\output',  # Image storage path
...
validation_generator = train_datagen.flow_from_directory(
    r'C:\Users\huimin.chen\projects\chm-vowel\vowelRecognition\output',  # Same image path
    target_size=(128, 128),
    batch_size=32,
    class_mode='categorical',
...
output_dir = os.path.join(r'C:\Users\huimin.chen\projects\chm-vowel\vowelRecognition\analysis_results', timestamp)
